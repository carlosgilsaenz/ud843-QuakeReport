...
/**
 * Created by Mick Jagger on 2/20/2017.
 */
...
public final class QueryUtils {
    ...
    /**
     * Return a list of {@link SeismicData} objects that has been built up from
     * parsing a JSON response.
     */
    public static ArrayList<SeismicData> extractEarthquakes() {

        // Create an empty ArrayList that we can start adding earthquakes to
        ArrayList<SeismicData> earthquakes = new ArrayList<>();
